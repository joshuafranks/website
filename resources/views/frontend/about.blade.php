...
@section('content')
    ...
    <article class="w-full mx-auto p-12 bg-white">
        <div class="flex flex-col text-center justify-center items-center bg-white md:text-left">
            <div class="flex flex-col justify-center container w-3/4 py-12 md:p-12">
                <div class="flex justify-center flex-row text-lg">
                    <div class="font-light text-grey-darkest text-left leading-normal text-xl md:mr-12 md:w-2/3">
                        <h2 class="text-blue-navy text-3xl mb-2">Our Story</h2>
                        <h3 class="mb-8 leading-normal text-grey-darker md:text-2xl">
